...
def test_files():
    ...
    for file in files:
        ...
        model_path = f"models/a2_500s/trained_policy_{file}.pth"
        try:
    ...
    results_df.to_csv("test_results_summary_a2_.csv", index=False)
    print("Test results saved to test_results_summary_a2_.csv")
